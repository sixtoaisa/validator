...
namespace Validator
{
    public partial class FrmValidarDocumento : Form
    {
        ...
        {            
            dataGrid.Rows.Add("FA", "F001", "011661", "2021.09.28", "LDM, PERU", 511.00, "XML", "301", "Enviar");
            dataGrid.Rows.Add("FA", "F001", "011663", "2021.09.28", "BOTICA ROUSS FARMA", 1015.00, "XML", "-", "Enviar");
            dataGrid.Rows.Add("FA", "F001", "011666", "2021.09.28", "BOTICA ANY FARMA", 196.00, "XML", "302", "Enviar");
            ...
            dataGrid.Rows.Add("FA", "F001", "011675", "2021.09.28", "MERLIN DORADO S.A.C.", 478.40, "XML", "302", "Enviar");
            ...
            dataGrid.Rows.Add("FA", "F001", "011690", "2021.09.29", "BOTICA MIA FARMA", 20.10, "XML", "302", "Enviar");
